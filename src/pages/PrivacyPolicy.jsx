export default function PrivacyPolicy() {
  return (
    <div style={{ maxWidth: 680, margin: '0 auto', padding: '40px 24px', fontFamily: 'Inter, sans-serif', color: '#1A1917', lineHeight: 1.7 }}>
      ...
      <p>Automated maintenance research is disabled, and SideFlip no longer sends new vehicle or item details to xAI for that purpose. Details from requests submitted before shutdown may remain with xAI only for its applicable retention window under its privacy terms.</p>
      ...
      <ul>
        ...
        <li><strong>xAI</strong> — user-requested listing-description generation; previously submitted maintenance-research requests may remain for the applicable retention window (<a href="https://x.ai/legal/privacy-policy" style={{ color: '#C8402F' }}>Privacy Policy</a>)</li>
      ...
      <p>We retain your account data for as long as your account is active. Product analytics events are automatically deleted after 12 months. VIN decode cache entries expire after 30 days; the cache contains decoded fields, NHTSA warning codes, and an HMAC-derived lookup key, not the full VIN. VIN-request rate-limit records are eligible for cleanup after seven days without an update. If you cancel your subscription and request account deletion, we will delete your account data within 30 days. Contact us at tyler@tourbillionenergy.com to request deletion.</p>
