...
export function createAppleServerApiClient() {
  const { APPLE_IAP_ENVIRONMENT: environmentName, APPLE_SERVER_API_PRIVATE_KEY: signingKey, APPLE_SERVER_API_KEY_ID: keyId, APPLE_SERVER_API_ISSUER_ID: issuerId } = process.env
