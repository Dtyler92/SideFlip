...
reset role;
select public._test_assert_v3((select client_mutation_id='transfer-v3:10000000-0000-4000-8000-000000000003' from public.my_stuff_items where id=:'direct_v3_item') and (select count(*)=0 from public.my_stuff_v2_mutations where user_id='44444444-4444-4444-8444-444444444444'),'V3 creates its item without delegating to V2');
